...
class HouseDetailUser extends StatefulWidget {
  final HouseModel houseModel;
  HouseDetailUser([this.houseModel]);
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return HouseDetailStateUser();
  }
}

class HouseDetailStateUser extends State<HouseDetailUser> {
  @override
  void initState() {
                              ...
                              itemBuilder: (context, index) {
                                return Card(
                                  child: ListTile(
                                    ...
                                    subtitle: Text(
                                        houses[index].houseMobile.toString()),
                                    leading: CircleAvatar(
